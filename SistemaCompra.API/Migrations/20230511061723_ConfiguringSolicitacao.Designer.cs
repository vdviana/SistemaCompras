...
namespace SistemaCompra.API.Migrations
{
    ...
    [Migration("20230511061723_ConfiguringSolicitacao")]
    partial class ConfiguringSolicitacao
    {
            ...
            modelBuilder.Entity("SistemaCompra.Domain.ProdutoAggregate.Produto", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("bbd99e39-6c8e-49b8-9cbd-53123bd026dc"),
                            Categoria = 1,
            ...
            modelBuilder.Entity("SistemaCompra.Domain.SolicitacaoCompraAggregate.SolicitacaoCompra", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("cdcc6da3-7656-4f8f-8faa-17f0d7c0e9d4"),
                            CondicaoPagamento = 30,
                            Data = new DateTime(2023, 5, 11, 3, 17, 23, 335, DateTimeKind.Local).AddTicks(7139),
